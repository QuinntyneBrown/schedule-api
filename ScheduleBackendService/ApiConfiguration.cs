...
using System;
using ScheduleBackendService.App_Start;
using ScheduleBackendService.Utilities;
using ScheduleBackendService.Configuration;
using ScheduleBackendService.Services;
using ScheduleBackendService.Authentication;
using ScheduleBackendService.Filters;

namespace ScheduleBackendService
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "ScheduleApi"))
                .EnableSwaggerUi();
